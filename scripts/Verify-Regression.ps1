...
$cases=@(
 ...
 'thumbnail-priority','menu-availability','format-choices','filter-panel','navigation-roots','tree-current-folder','wheel-distance','prefetch-adoption','prefetch-turnaround','prepared-cache',
