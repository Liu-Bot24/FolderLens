...
internal static class ScanPathProbe
{
    public static ScanDirectoryPacket Read(string path,bool allowCloud=false)
    {
        ...
        try
        {
            ...
            var identity=FileAllocation.InspectMetadata(path);
            ...
            return new("present",[],PhysicalIdentity:identity.PhysicalIdentity,VolumeIdentity:identity.VolumeIdentity,CaseMode:identity.CaseMode,FileStamp:stamp);
        }
