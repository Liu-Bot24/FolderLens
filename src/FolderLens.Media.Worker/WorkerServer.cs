        ...
        try
        {
            while(pipe.IsConnected)
            {
                ...
                try
                {
                    ...
                    var actual=request.Operation=="probe"?(decoder!.Width,decoder.Height,"fit"):decoder!.Render(Path.Combine(taskDirectory,token+".png"),parameters.TargetWidth,parameters.TargetHeight,request.Operation=="fullTile",parameters.TileX,parameters.TileY,request.Operation=="rawEmbedded");
                    CheckSource();
