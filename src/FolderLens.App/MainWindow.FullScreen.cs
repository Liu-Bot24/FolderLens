...
public sealed partial class MainWindow
{
    ...
    private void InitializeFullScreen()
    {
        ...
        AddViewerActionButton(controls,"适应屏幕",ViewerAction.ToggleFit);AddViewerActionButton(controls,"100%",ViewerAction.Actual);AddViewerActionButton(controls,"适合宽度",ViewerAction.FitWidth);AddViewerActionButton(controls,"适合高度",ViewerAction.FitHeight);AddViewerActionButton(controls,"旋转",ViewerAction.Rotate);
