...
public sealed partial class MainWindow
{
    ...
    private async Task PlayVideoCore()
    {
        ...
        try
        {
            ...
            void StateChanged(MediaPlaybackSession sender,object args)=>OnCurrent(()=>PreviewExternalPlayer.Content=player.PlaybackSession.PlaybackState==MediaPlaybackState.Playing?"暂停":"播放");
